...
const LINK_QRIS_DANA = 'https://i.imgur.com/D5kz35E.png
    ';
...
function handlePaymentChange() {
    ...
    if (method === 'qris') {
        ...
        instruction.innerHTML = "<strong>Info QRIS:</strong> Gambar QRIS DANA akan muncul setelah menekan tombol di bawah. Silakan scan/screenshot untuk membayar, lalu sistem akan meneruskan rincian ke WhatsApp toko.";
...
function checkout() {
    ...
    orderDetailsGlobal = `*Halo Kak, Saya mau pesan Mie Ayam!*\n\n` +
                         `*Detail Pesanan:*\n${itemText}\n` +
    ...
    if (method === 'qris') {
        modalTitle.innerText = "Scan QRIS DANA";
        modalContent.innerHTML = `
            ...
            <div class="border-2 border-dashed border-gray-300 p-2 rounded-lg bg-gray-50 flex justify-center items-center qr-container">
                <img src="${LINK_QRIS_DANA}" alt="QRIS DANA" onerror="this.src='https://i.imgur.com/D5kz35E.png
                '
